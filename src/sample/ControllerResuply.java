...
public class ControllerResuply {
    @FXML private TableView<Good> tableViewForRes;
    ...
    void initialize() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                tableViewForRes.setItems(getGoods(id, name, model, price, count));
            }
        ...
        resuplyBtn.setOnAction(event -> {
            dbHandler.resuplyGood(resuplyInputID.getText(), resuplyInputCount.getText());
        });
    }
